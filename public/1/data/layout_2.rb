...
qrcode 	= RLayout::Image.new(tag: "qrcode", local_image: "qrcode/정익순.png", width: 200, height: 200)
# This goes somewhere in the middle
personal = RLayout::Container.new(tag: "personal", width: 150, height: 60) do
  text("정익순", tag: "name", text_size: 12, font: "smGothicP-W70")
  text("사장", tag: "title", text_size: 12, font: "smMyungjoP-W30")
